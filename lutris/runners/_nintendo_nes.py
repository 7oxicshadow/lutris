...
class _nintendo_nes(Runner):
    human_name = "Nintendo NES"
    description = "Runs NES Games"
    platforms = ['Nintendo NES']
    runner_executable = '/mnt/data/emulators/emulator_scripts/nes/scripts/nes_game.sh'
    game_options = [{
        'option': 'main_file',
        'type': 'file',
