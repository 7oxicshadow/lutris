...
class _jaguar(Runner):
    human_name = "Atari Jaguar"
    description = "Runs Jaguar Games"
    platforms = ['Atari Jaguar']
    runner_executable = '/mnt/data/emulators/emulator_scripts/jaguar/scripts/jaguar_game.sh'
    game_options = [{
        'option': 'main_file',
        'type': 'file',
